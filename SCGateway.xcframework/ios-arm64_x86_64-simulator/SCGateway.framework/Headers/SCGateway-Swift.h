...
- (nonnull instancetype)initWithSmallplugHeaderColor:(NSString * _Nullable)smallplugHeaderColor headerColorOpacity:(NSNumber * _Nullable)headerColorOpacity OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
