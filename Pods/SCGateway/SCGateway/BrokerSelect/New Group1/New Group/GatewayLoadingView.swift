...
class GatewayLoadingView: UIView {
    ...
    fileprivate func setupLayouts() {
        ...
        stackView.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 96).isActive = true
        ...
        poweredByContainer.heightAnchor.constraint(equalToConstant: 64).isActive = true
