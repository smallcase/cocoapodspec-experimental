...
plist_path = "Loans/Info.plist"
podspec_path = "SCLoans.podspec.json"
aws_bucket = "ios_sdk_loans"
commit_message = "chore(release): "
  ...
  set_plist_value(plist_path, "CFBundleShortVersionString", scloans_version)
  update_podspec(podspec_path, scloans_version, "https://gateway.smallcase.com/#{aws_bucket}/#{scloans_version}/Loans.xcframework.zip")
